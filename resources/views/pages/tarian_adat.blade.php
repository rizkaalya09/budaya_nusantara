...
<header id="header">
    <div class="user-logo container">
        <div>
            <h1>
                <a href="{{ route('home') }}" id="logo">Tarian Adat</a>
            </h1>
        </div>
    </div>
</header>
...
<div class="container-province">
    ...
    <div class="search-container">
        ...
        <form id="filter-form" action="{{ route('tarian_adat') }}" method="GET">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateURL(newIndex) {
            ...
            window.location.href = `{{ route('tarian_adat') }}?province_id=${selectedProvinceId}`;
        }
