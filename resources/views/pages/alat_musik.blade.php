...
<header id="header">
    <div class="user-logo container">
        <div>
            <h1>
                <a href="{{ route('home') }}" id="logo">Alat Musik</a>
            </h1>
        </div>
    </div>
</header>
...
<div class="container-province">
    ...
    <div class="search-container">
        ...
        <form id="filter-form" action="{{ route('alat_musik') }}" method="GET">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateURL(newIndex) {
            ...
            window.location.href = `{{ route('alat_musik') }}?province_id=${selectedProvinceId}`;
        }
