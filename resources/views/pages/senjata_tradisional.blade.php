...
<header id="header">
    <div class="user-logo container">
        <div>
            <h1>
                <a href="{{ route('home') }}" id="logo">Senjata Tradisional</a>
            </h1>
        </div>
    </div>
</header>
...
<div class="container-province">
    ...
    <div class="search-container">
        ...
        <form id="filter-form" action="{{ route('senjata_tradisional') }}" method="GET">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateURL(newIndex) {
            ...
            window.location.href = `{{ route('senjata_tradisional') }}?province_id=${selectedProvinceId}`;
        }
